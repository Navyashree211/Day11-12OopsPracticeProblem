package com.bridgelabz.oopsproblem;

import java.util.Random;

//public class ExtendDackOfCards  {  
	
/** Extend the Deck of card to create a player object having deck of cards
	and ability to store by rank and maintain the cards in a Queue 
